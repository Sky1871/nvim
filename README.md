...
A modern, fast, and modular Neovim configuration written in Lua and managed by **lazy.nvim**. Pre-configured for full-stack development, LSP diagnostics, Git workflows, tmux integration, test runners, and 42 School toolchains.
...
| `mouse` | `"a"` | Enables mouse support across all modes.
 ...
 |
| `showmode` | `false` | Hides redundant mode display text.
